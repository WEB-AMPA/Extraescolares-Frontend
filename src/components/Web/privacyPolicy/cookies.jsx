...
function CookiePolicy(){
  return (
    <div className="flex flex-col gap-5 p-10">
      <h1 className="text-center text-2xl font-bold text-yellow-500">Tecnologías de Seguimiento y Cookies</h1>
      <p className="mb-4">
      ...
      <h2 className="text-center text-xl font-semibold mb-2"  style={{ color: "#3854A6" }}>Cookies Persistentes o de Sesión</h2>
